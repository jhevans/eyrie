    ...
    function jQMatchers() {
        ...
        return {
            toExist: function toExist() {
                return {
                    compare: function compare(actual, description) {
                        var pass,
                    ...
                    negativeCompare: function negativeCompare(actual, description) {
                        var pass,
            ...
            toHaveHtml: function toHaveHtml(expected) {
                return {
                    compare: function compare(actual, description) {
                        var pass,
...
$__System.register('3', [], function (_export) {
    ...
    _export('default', compileMessages);

    function compileMessages(results, prefix) {
        'use strict';
        var message = prefix || "";
...
$__System.register("6", ["7", "8"], function (_export) {
    var _createClass, _classCallCheck, UnexpectedMatcher;
    ...
    return {
        ...
        execute: function () {
            ...
            UnexpectedMatcher = (function () {
                function UnexpectedMatcher(jQActual) {
                    _classCallCheck(this, UnexpectedMatcher);

                    this.unexpected = jQActual.children();
                }

                _createClass(UnexpectedMatcher, [{
                    key: "allow",
                    value: function allow(selector) {
                        this.unexpected = this.unexpected.not(selector);
                    }
                }, {
                    key: "hasUnexpected",
                    value: function hasUnexpected() {
                        return this.unexpected.length > 0;
                    }
                }, {
                    key: "getUnexpectedMessage",
                    value: function getUnexpectedMessage() {
                        return "Unexpected Element: '." + this.unexpected.attr('class') + "'";
                    }
                }, {
                    key: "getUnexpectedResult",
                    value: function getUnexpectedResult() {
                        return {
                            pass: false,
            ...
            _export("default", UnexpectedMatcher);
...
$__System.registerDynamic("7", ["b"], true, function($__require, exports, module) {
  "use strict";
  ;
  var global = this,
      __define = global.define;
...
$__System.register('c', ['3', '5', '6', '7', '8'], function (_export) {
    var compileMessages, _, UnexpectedMatcher, _createClass, _classCallCheck, Matcher;

    return {
        setters: [function (_6) {
            compileMessages = _6['default'];
        }, function (_5) {
            _ = _5['default'];
        }, function (_4) {
            UnexpectedMatcher = _4['default'];
        }, function (_2) {
        ...
        execute: function () {
            ...
            Matcher = (function () {
                ...
                _createClass(Matcher, [{
                    ...
                    value: function recursiveCompare() {
                        ...
                        _.keys(this.schema).forEach((function (selector) {
            ...
            _export('default', Matcher);
        }
    };
});
$__System.register('d', ['3', 'c'], function (_export) {
    'use strict';

    var compileMessages, Matcher;

    _export('default', schemaMatcher);

    function schemaMatcher() {
        'use strict';

        var EXPECTED_PREFIX = "Element does not match schema:\n";

        return {
            toMatchSchema: function toMatchSchema() {
                return {
                    compare: function compare(jQActual, expectedSchema) {
            ...
            toMatchSchemaExactly: function toMatchSchemaExactly() {
                return {
                    compare: function compare(jQActual, expectedSchema) {
...
$__System.register('1', ['2', 'f', 'd'], function (_export) {
    'use strict';

    var jQMatchers, $, schemaMatcher, element;
    return {
        setters: [function (_) {
            jQMatchers = _['default'];
        }, function (_f) {
            $ = _f['default'];
        }, function (_d) {
            schemaMatcher = _d['default'];
        }],
        execute: function () {
            element = $('body');
